    ...
    <div class="container youplay-content">
      ...
      <div class="col-md-9">
        ...
        <form action="http://html.nkdev.info/youplay/shooter/search.html" class="pull-right">
          ...
          <button class="btn pull-right">Искать</button>
        </form>
        <!-- /Search -->
        ...
        <ul class="youplay-forum mr-10">
          <li class="header">
            <ul>
              ...
              <li class="cell-info">Форум</li>
              <li class="cell-topic-count">Темы</li>
              <li class="cell-reply-count">Посты</li>
              <li class="cell-freshness">Свежие</li>
            </ul>
          </li>
          ...
          <li class="body">
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Игры</a>
                <div class="description">Игры для различных консолей</div>
              ...
              <li class="cell-freshness">
                <a href="#!">1 год, 2 месяца назад</a>
                <p>
                  <a href="#!">
                    <img alt="" src="assets/images/avatar-user-2.png" height="25" width="25">Владимир Смирнов
                  </a>
                </p>
              </li>
            </ul>
            ...
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Косплей</a>
                <div class="description">Одежда (Категории)</div>
                <ul class="forums-list">
                  <li><a href="#!"><i class="fa fa-folder-open-o"></i> Мужчины</a>,</li>
                  <li><a href="#!"><i class="fa fa-folder-open-o"></i> Женщины</a>
                  </li>
                </ul>
              </li>
            ...
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Мобильные приложения</a>
                <div class="description">Форум мобильных приложений</div>
              </li>
              <li class="cell-topic-count">0</li>
              <li class="cell-reply-count">0</li>
              <li class="cell-freshness">
            ...
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Мобильные игры</a>
                <div class="description">Форум мобильных игр</div>
              </li>
              <li class="cell-topic-count">1</li>
              <li class="cell-reply-count">1</li>
              <li class="cell-freshness">
                <a href="#!">4 месяца, 1 неделя назад</a>
                <p>
            ...
            <ul>
              ...
              <li class="cell-info">
                <a href="#!" class="title h4">Магазин устройств</a>
                <div class="description">Купить и продать старые устройства</div>
              </li>
              <li class="cell-topic-count">0</li>
              <li class="cell-reply-count">0</li>
              <li class="cell-freshness">
      ...
      <div class="col-md-3">
        ...
        <div class="side-block">
          ...
          <ul class="block-content">
            ...
            <li><a href="#!">Приключения</a>
            </li>
            <li><a href="#!">Казуальные</a>
            </li>
            <li><a href="#!">Инди</a>
            </li>
            <li><a href="#!">Гонки</a>
            ...
            <li><a href="#!">Симуляторы</a>
            </li>
            <li><a href="#!">Стратегия</a>
            </li>
          </ul>
        </div>
        <!-- /Side Categories -->
              ...
              <div class="col-md-3">
                <div class="side-block">
                  <div class="block-content">
                    ...
                    <br>
                    <p>
                      Взрослые считают, что игры – это в основном развлечение. А ведь это неправда! Мы же не стыдимся проводить время у телевизора. Вот и в компьютерных играх нет ничего постыдного.
                    </p>
                  </div>
                </div>
              </div>
