      ...
      <div class="col-md-9">
        ...
        <article class="news-one">
          ...
          <div class="description">
            ...
            <p>
              Painkiller – уникальное явление в игровой индустрии. При отсутствии принципиально новых для жанра FPS идей и интересного сюжета, она умудрилась стать одним из топовых представителей среди так называемых «мясных» шутеров на ПК
            </p>
          </div>
          <!-- /Post Text -->
          ...
          <div class="meta">
            <div class="item">
              ...
              Автор <a href="#!">Modest</a>
            </div>
            <div class="item">
              <i class="fa fa-calendar meta-icon"></i>
              Опубликовано <a href="#!">Febriary 14, 2022</a>
            </div>
            <div class="item">
            ...
            <li>
              <article>
                ...
                <div class="comment-cont clearfix">
                  <a class="comment-author h4" href="#!">Кристина Арбузова</a>
                  <div class="date">
                    <i class="fa fa-calendar"></i> 25 minutes ago
                    <a href="#!" class="pull-right"><i class="fa fa-reply"></i> Reply</a>
                  </div>
                  <div class="comment-text">
                    Купила игру, насмотревшись трансляций друга. Установила и решила поиграть. Игра действительно неплохая. Бегаешь себе, убиваешь всякую нечисть, сражаешься с боссами. Обстановка в игре довольно мрачноватая. Мне бы, конечно, хотелось побольше света. А вообще, интересно)
                  </div>
                </div>
              </article>
              ...
              <ul class="child-comment">
                ...
                <li>
                  <article>
                    ...
                    <div class="comment-cont clearfix">
                      <a class="comment-author h4" href="#!">Павел Андреев</a>
                      <div class="date">
                        <i class="fa fa-calendar"></i> 5 minutes ago
                        <a href="#!" class="pull-right"><i class="fa fa-reply"></i> Reply</a>
                      </div>
                      <div class="comment-text">
                        Отличный олдскульный мясной шутер!
                      </div>
                    </div>
                  </article>
                </li>
                ...
                <div class="side-block">
                  ...
                  <div class="block-content p-0">
                    ...
                    <div class="row youplay-side-news">
                      ...
                      <div class="col-xs-9 col-md-8">
                        <h4 class="ellipsis"><a href="blog-post-1.php" title="Whats New in Middle-earth">Grand Theft Auto III ("Великий автоугонщик")</a></h4>
                        <span class="date"><i class="fa fa-calendar"></i> Febriary 22, 2022</span>
                      </div>
                    </div>
                    <!-- /Single News Block -->
